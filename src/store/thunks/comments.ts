...
const fetchComments = createAsyncThunk<Review[], FullOffer['id'], ThunkApi>('comments/fetch', async (offerId, { extra: api }) => {
...
const postComment = createAsyncThunk<Review, PostCommentProps, ThunkApi>('comments/post', async ({ body, offerId }, { extra: api }) => {
