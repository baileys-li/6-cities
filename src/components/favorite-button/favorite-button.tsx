...
function FavoriteButton_({ bemBlock = 'place-card', isFavorite = false, offerId, width = 18 }: FavoriteButtonProps) {
	...
	return (
		<button className={favoriteClass} onClick={handleClick} type="button">
			<svg className={`${bemBlock}__bookmark-icon`} height={height} width={width}>
