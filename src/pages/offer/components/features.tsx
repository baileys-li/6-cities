...
const Features_ = ({ bedrooms, maxAdults, type }: FeaturesProps) => (
	<ul className="offer__features">
		...
		<li className="offer__feature offer__feature--bedrooms">{formatBedroom(bedrooms)}</li>
		<li className="offer__feature offer__feature--adults">{formatAdults(maxAdults)}</li>
	</ul>
)
