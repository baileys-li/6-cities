...
import { selectOffer, selectRandomNearbySlice } from '../../../store/selectors/offer'
...
export function OfferPage() {
	...
	const { bedrooms, city, description, goods, host, id, images, isFavorite, isPremium, maxAdults, price, rating, title = '', type = '' } = offer
	...
	return (
		<>
			<section className="offer">
				...
				<div className="offer__container container">
					<div className="offer__wrapper">
						...
						<div className="offer__name-wrapper">
							...
							<FavoriteButton bemBlock="offer" isFavorite={isFavorite} offerId={id} width={31} />
						</div>
				...
				<Map city={city.name} className="offer__map" offers={[...nearbyOffers, offer]} />
			</section>
