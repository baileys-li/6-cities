...
export function ReviewForm() {
	...
	return (
		<form action="#" className="reviews__form form" method="post" onInput={handleInput} onSubmit={handleSubmit} ref={formRef}>
			...
			<div className="reviews__button-wrapper">
				...
				<button className="reviews__submit form__submit button" disabled={isSubmitDisabled} type="submit">
					Submit
				</button>
			</div>
		</form>
